 ...
 * A sequence of items
 */
export declare class Sequence<TItem> implements Iterable<TItem> {
    protected _iterable: Iterable<TItem>;
    constructor(_iterable: Iterable<TItem>);
     ...
     * ```
     */
    groupBy<TKey extends keyof TItem>(key: TKey): Sequence<Grouping<TItem[TKey], TItem>>;
    /**
     ...
     * ```
     */
    groupBy<TKey>(keySelector: KeySelectorFn<TItem, TKey>): Sequence<Grouping<TKey, TItem>>;
    /**
     ...
     * ```
     */
    groupBy<TKey extends keyof TItem, TElement>(key: TKey, elementSelector: MapFn<TItem, TElement>): Sequence<Grouping<TItem[TKey], TItem>>;
    /**
     ...
     * ```
     */
    groupBy<TKey, TElement>(keySelector: KeySelectorFn<TItem, TKey>, elementSelector: MapFn<TItem, TElement>): Sequence<Grouping<TKey, TElement>>;
    /**
     ...
     * ```
     */
    pick<TKeys extends keyof TItem>(...keys: TKeys[]): Sequence<{
        [P in TKeys]: TItem[P];
    }>;
    /**
     ...
     * ```
     */
    sortBy<TKey>(keySelector: KeySelectorFn<TItem, TKey>, comparer?: ComparerFn<TKey>): OrderedSequence<TItem>;
    /**
     ...
     * ```
     */
    sortByDescending<TKey = TItem>(keySelector?: KeySelectorFn<TItem, TKey>, comparer?: ComparerFn<TKey>): OrderedSequence<TItem>;
    /**
     ...
     */
    toMap<TKey, TElement = TItem>(keySelectorFn: MapFn<TItem, TKey>, elementSelectorFn?: MapFn<TItem, TElement>): Map<TKey, TElement>;
    /**
     ...
     */
    toSet(): Set<TItem>;
    private _sequenceFromGenerator;
}
/**
 * Ordered sequence of elements
 */
export declare class OrderedSequence<TItem> extends Sequence<TItem> {
    private _iterableToSort;
    private _comparer;
    constructor(_iterableToSort: Iterable<TItem>, comparer: ComparerFn<TItem>);
    thenBy<TOtherKey>(keySelector: KeySelectorFn<TItem, TOtherKey>, comparer?: ComparerFn<TOtherKey>): OrderedSequence<TItem>;
    thenByDescending<TOtherKey>(keySelector: KeySelectorFn<TItem, TOtherKey>, comparer?: ComparerFn<TOtherKey>): OrderedSequence<TItem>;
}
